                        ...
                        <div className="p-6">
                            ...
                            <div className="mb-4">
                                {project.tags.map((tag,index)=>(
                                    <span key={index}
                                    className="inline-block bg-[#251f35] text-xs font-semibold text-purple-500 rounded-full px-2 py-1 mr-2 mb-2">
                                        {tag}
                                    </span>
                                ))}
                    ...
                    <div className="bg-gray-900 rounded-xl shadow-2xl lg:w-full w-[90%] max-w-3xl overflow-hidden relative">
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="lg:p-8 p-6">
                                <h3 className="lg:text-3xl font-bold text-white mb-4 text-mb">{selectedProject.title}</h3>
                                <p className="text-gray-400 mb-6 lg:text-base text-xs">{selectedProject.description}</p>
                                <div className="flex flex-wrap gap-2 mb-6">
                                    {selectedProject.tags.map((tag,index)=>(
                                        <span key={index}
                                              className=" bg-[#251f35] text-xs font-semibold text-purple-500 rounded-full px-2 py-1">
                                        {tag}
                                    </span>
